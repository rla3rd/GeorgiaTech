...
from mymodels import MyMLP, MyCNN, MyRNN, MyMLP2, MyCNN2, MyRNN2
...
NUM_EPOCHS = 40 # base run is 40
BATCH_SIZE = 10 # base run is 10
...
data_tensor, target_tensor = train_dataset.tensors
